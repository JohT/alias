 ...
 * @author JohT
 */
class AliasableTypeResourceBundleValidator {
	...
	public static final Collection<String> errorsOf(ResourceBundle resourceBundle) {
		return new AliasableTypeResourceBundleValidator(resourceBundle).validate();
	}
	...
	protected AliasableTypeResourceBundleValidator(ResourceBundle resourceBundle) {
